...
public class ReturnCarCommand : ICommand
{
    ...
    public string Key => "4";
    public string Description => "Повернути авто";

    public ReturnCarCommand(RentalService service, Func<Task> saveAsync)
    {
        _service = service;
